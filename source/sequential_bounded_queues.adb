...
package body Sequential_Bounded_Queues with SPARK_Mode is
   ...
   procedure Put (This : in out Queue; Item : Element) is
   begin
   ...
   procedure Get (This : in out Queue; Item : out Element) is
   begin
   ...
   is
      Result : Queue_Model (1 .. This.Length) := (others => Default_Value);
   begin
   ...
   function First_Iter_Index (This : Queue) return Positive_Element_Count is
     (This.First);
   ...
   function Next_Iter_Index (Unused : Queue; Position : Positive_Element_Count) return Positive_Element_Count is
   ...
   function Iter_Value (This : Queue; Position : Positive_Element_Count) return Element is
   ...
   function Iter_Has_Element (This : Queue;  Position : Positive_Element_Count) return Boolean is
      Result           : Boolean;
