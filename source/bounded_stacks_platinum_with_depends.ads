...
--  This is a version of the Platinum level implementation that includes
--  explicit data dependency contracts. You could use this as the ultimate
--  version if you prefer. You may want to rename the unit
--  Bounded_Sequential_Stacks.
